...
推荐技术栈为 DevEco Studio + ArkTS + ArkUI + Stage/UIAbility + Hvigor。当前首版只使用系统 UI、Preferences、文件 Picker、JSON 标准能力和基础布局自绘图表，不使用网络、第三方图表库、WebView 或云端 AI。Natural Language Kit、Core Vision Kit 和小艺开放平台均只作为后续调研方向。
